...
public enum EnumTypeExceptions {
    ...
    LIMIT_ATTEMPT_EXCEEDED("The limit of attempts has been exceeded, has been definitively rejected"),
    ...
    PROCESS_FAILED("The current process has been definitively rejected"),
